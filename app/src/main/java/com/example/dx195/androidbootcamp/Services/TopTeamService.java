...
import com.example.dx195.androidbootcamp.Services.TopTeamServiceParser;
...
public class TopTeamService {
    static final String TOP_TEAM_URL = "http://api.sportsdatallc.org/ncaafb-t1/polls/AP25/2013/2/rankings.json?api_key=jmtzp6kchp9n9vka5s7e6hje";
